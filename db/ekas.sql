...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 28, 2023 at 10:00 AM
...
(2, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin ekas', '+6281332456712', 'tstamp');
...
CREATE TABLE IF NOT EXISTS `resp_hps_adm` (
`id` int(11) NOT NULL,
  `nama` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tb_jenis_pembayaran` (
`id` int(11) NOT NULL,
  `tapel` text NOT NULL,
  `kelas` text NOT NULL,
